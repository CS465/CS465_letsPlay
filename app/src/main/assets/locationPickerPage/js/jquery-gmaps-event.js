...
var GMapsLatLonPicker = (function() {
	...
	var publicfunc = {
		...
		init : function(object) {
			...
			// Search function by gllp_add_marker listener
			$(document).bind("gllp_add_marker", function(event, info) {
				...
				google.maps.event.addListener(marker, 'click', function(){
					infoWindow.setContent('<h1>' + marker.title + '</h1>' + marker.content + '<br><button>Join</button>');
			...
			// Search function by gllp_clear_marker listener
			$(document).bind("gllp_clear_marker", function(event, info) {
